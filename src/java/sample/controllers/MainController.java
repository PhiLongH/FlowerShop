...
public class MainController extends HttpServlet {
    ...
    private static final String ADMIN_SHOPPING="Admin_Product_Page";
    private static final String ADMIN_SHOPPING_PAGE="adminShopping.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(action == null) {
                ...
                url = EDIT_CONTROLLER;
            }else if(ADMIN_SHOPPING.equals(action)) {
                url = ADMIN_SHOPPING_PAGE;
